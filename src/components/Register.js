        ...
        <div className=' relative flex mx-36 bg-[#0C4195] h-[700px] w-10/12 mt-20 justify-end rounded-r-[22px]'>
            ...
            <div className='w-8/12 h-[700px] bg-white rounded-[22px]'>
                ...
                <form class="relative ml-56">
                    <input type="text" class="w-8/12 p-4 border-b-2 border-gray-300 focus:border-blue-500 outline-none mb-4" placeholder='Fullname'></input>
                    <input type="text" class="w-8/12 p-4 border-b-2 border-gray-300 focus:border-blue-500 outline-none mb-4" placeholder='Email Address'></input>
                    ...
                    <input type="text" class="w-8/12 p-4 border-b-2 border-gray-300 focus:border-blue-500 outline-none mb-4" placeholder='Re-password'></input>
                    <button className='h-[70px] w-6/12 text-white bg-[#0C4195] rounded-[9px] mx-16 mt-8'>Register</button>
                </form>
